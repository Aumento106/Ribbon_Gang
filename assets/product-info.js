  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      setUnavailable() {
        ...
        const selectors = ['price', 'Inventory', 'Sku', 'Price-Per-Item', 'Volume-Note', 'Volume', 'Quantity-Rules', 'ShippingBar']
      ...
      fetchQuantityRules() {
        ...
        this.querySelector('.quantity__rules-cart')?.querySelector('.loading__spinner').classList.remove('hidden');
        fetch(`${this.dataset.url}?variant=${currentVariantId}&section_id=${this.dataset.section}`)
          ...
          .finally(() => this.querySelector('.quantity__rules-cart')?.querySelector('.loading__spinner').classList.add('hidden'));
      }
